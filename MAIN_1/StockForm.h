...
namespace MAIN1 {
	...
	private:
		ref class AddStockListenerImpl : public AddStockForm::Listener
		{
		public:
			AddStockListenerImpl(StockForm^ parent) : m_parent(parent) {}
		...
		ref class UpdateStockListenerImpl : public UpdateStockForm::Listener
		{
		public:
			UpdateStockListenerImpl(StockForm^ parent) : m_parent(parent) {}
	...
	private: System::Windows::Forms::FlowLayoutPanel^ stockLayoutPanel;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->stockLayoutPanel = (gcnew System::Windows::Forms::FlowLayoutPanel());
			...
			this->stockLayoutPanel->SuspendLayout();
			...
			// stockLayoutPanel
			// 
			this->stockLayoutPanel->Controls->Add(this->panel2);
			this->stockLayoutPanel->Controls->Add(this->panelDataGridView);
			this->stockLayoutPanel->Location = System::Drawing::Point(12, 12);
			this->stockLayoutPanel->Margin = System::Windows::Forms::Padding(3, 2, 3, 2);
			this->stockLayoutPanel->Name = L"stockLayoutPanel";
			this->stockLayoutPanel->Size = System::Drawing::Size(1203, 662);
			this->stockLayoutPanel->TabIndex = 0;
			// 
			// panel2
			// 
			...
			this->btnsearch->Click += gcnew System::EventHandler(this, &StockForm::btnsearch_Click);
			// 
			// textBoxsearch
			// 
			...
			this->textBoxsearch->TextChanged += gcnew System::EventHandler(this, &StockForm::textBoxsearch_TextChanged);
			this->textBoxsearch->Enter += gcnew System::EventHandler(this, &StockForm::textBoxsearch_Enter);
			this->textBoxsearch->KeyDown += gcnew System::Windows::Forms::KeyEventHandler(this, &StockForm::textBoxsearch_KeyDown);
			// 
			// btndelete
			// 
			...
			this->btnadd->Click += gcnew System::EventHandler(this, &StockForm::button1_Click);
			// 
			// btnupdate
			// 
			...
			this->Controls->Add(this->stockLayoutPanel);
			this->FormBorderStyle = System::Windows::Forms::FormBorderStyle::None;
			this->Margin = System::Windows::Forms::Padding(4);
			this->Name = L"StockForm";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"Order";
			this->stockLayoutPanel->ResumeLayout(false);
...
#pragma endregion
	public: System::Void refresh_dataGridView() {
		...
		this->dataGridView->DataSource = ServiceItem().GetDataSet();
		this->dataGridView->DataMember = "Item";
	}
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
		this->addStockForm = gcnew AddStockForm(gcnew AddStockListenerImpl(this));
		this->addStockForm->Show();
	}
	...
	private: System::Void btndelete_Click(System::Object^ sender, System::EventArgs^ e) {
		if (this->dataGridView->SelectedRows->Count > 0)
		{
			...
			Item item;
			item = ServiceItem().Get(cellValue);
			ServiceStock().Remove(item.GetId());
			ServiceItem().Remove(item.GetId());
			refresh_dataGridView();
		}
	}
	private: System::Void btnupdate_Click(System::Object^ sender, System::EventArgs^ e) {
		if (this->dataGridView->SelectedRows->Count > 0)
		{
			...
			Item item;
			item = ServiceItem().Get(IDcellValue);

			Stock stock;
			stock = ServiceStock().Get(item.GetId());

			this->updateStockForm = gcnew UpdateStockForm(gcnew UpdateStockListenerImpl(this), item, stock);
			this->updateStockForm->Show();
		}
	}
	private: System::Void btnsearch_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		if (this->textBoxsearch->Text->ToString() != "") {
			this->dataGridView->Refresh();
			this->dataGridView->DataSource = BB8Manager_Core_Services::ServiceItem().GetSearchDataSet(marshal_as<std::string>(this->textBoxsearch->Text->ToString()));
			this->dataGridView->DataMember = "Item";
		}
		else {
			refresh_dataGridView();
	...
	private: System::Void textBoxsearch_TextChanged(System::Object^ sender, System::EventArgs^ e) {
		if (this->textBoxsearch->Text->ToString() != "") {
			this->dataGridView->Refresh();
			this->dataGridView->DataSource = ServiceItem().GetSearchDataSet(marshal_as<std::string>(this->textBoxsearch->Text->ToString()));
			this->dataGridView->DataMember = "Item";
		}
		else {
			refresh_dataGridView();
