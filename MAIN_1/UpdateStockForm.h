...
namespace MAIN1 {
	...
	public:
		...
		UpdateStockForm(Listener^ listener, Item item, Stock stock)
		{
			...
			this->textBoxprice->Text = gcnew String(std::to_string(item.GetPriceExclTaxes()).c_str());
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(UpdateStockForm::typeid));
			...
			this->panelheader->MouseDown += gcnew System::Windows::Forms::MouseEventHandler(this, &UpdateStockForm::UpdateStockForm_MouseDown);
			this->panelheader->MouseMove += gcnew System::Windows::Forms::MouseEventHandler(this, &UpdateStockForm::UpdateStockForm_MouseMove);
			this->panelheader->MouseUp += gcnew System::Windows::Forms::MouseEventHandler(this, &UpdateStockForm::UpdateStockForm_MouseUp);
			// 
			// btnclose
			// 
			...
			this->btnclose->Click += gcnew System::EventHandler(this, &UpdateStockForm::btnclose_Click);
			// 
			// textboxname
			// 
			...
			this->textboxname->GotFocus += gcnew System::EventHandler(this, &UpdateStockForm::textboxname_RemoveText);
			this->textboxname->LostFocus += gcnew System::EventHandler(this, &UpdateStockForm::textboxname_AddText);
			// 
			// textboxlot
			// 
			...
			this->textboxlot->GotFocus += gcnew System::EventHandler(this, &UpdateStockForm::textboxlot_RemoveText);
			this->textboxlot->LostFocus += gcnew System::EventHandler(this, &UpdateStockForm::textboxlot_AddText);
			// 
			// textBoxprice
			// 
			...
			this->textBoxprice->GotFocus += gcnew System::EventHandler(this, &UpdateStockForm::textBoxprice_RemoveText);
			this->textBoxprice->LostFocus += gcnew System::EventHandler(this, &UpdateStockForm::textBoxprice_AddText);
			// 
			// textBoxreorder
			// 
			...
			this->textBoxreorder->GotFocus += gcnew System::EventHandler(this, &UpdateStockForm::textBoxreorder_RemoveText);
			this->textBoxreorder->LostFocus += gcnew System::EventHandler(this, &UpdateStockForm::textBoxreorder_AddText);
			// 
			// textBoxstock
			// 
			...
			this->textBoxstock->GotFocus += gcnew System::EventHandler(this, &UpdateStockForm::textBoxstock_RemoveText);
			this->textBoxstock->LostFocus += gcnew System::EventHandler(this, &UpdateStockForm::textBoxstock_AddText);
			// 
			// labelItem
			// 
			...
			this->btncancel->Click += gcnew System::EventHandler(this, &UpdateStockForm::btncancel_Click);
			this->btncancel->MouseEnter += gcnew System::EventHandler(this, &UpdateStockForm::btncancel_OnMouseEnter);
			this->btncancel->MouseLeave += gcnew System::EventHandler(this, &UpdateStockForm::btncancel_OnMouseLeave);
			// 
			// btnapply
			// 
			...
			this->btnapply->Click += gcnew System::EventHandler(this, &UpdateStockForm::btnapply_Click);
			this->btnapply->MouseEnter += gcnew System::EventHandler(this, &UpdateStockForm::btnapply_OnMouseEnter);
			this->btnapply->MouseLeave += gcnew System::EventHandler(this, &UpdateStockForm::btnapply_OnMouseLeave);
			// 
			// comboBoxvat
			// 
			...
			this->Name = L"UpdateStockForm";
			this->Text = L"UpdateStockForm";
			this->Load += gcnew System::EventHandler(this, &UpdateStockForm::comboBox_Load);
...
#pragma endregion
	...
	private: System::Void UpdateStockForm_MouseDown(System::Object^ sender, System::Windows::Forms::MouseEventArgs^ e) {
		this->dragging = true;
		this->offset = Point(e->X, e->Y);
	}

	private: System::Void UpdateStockForm_MouseMove(System::Object^ sender, System::Windows::Forms::MouseEventArgs^ e) {
		if (this->dragging) {
	...
	private: System::Void UpdateStockForm_MouseUp(System::Object^ sender, System::Windows::Forms::MouseEventArgs^ e) {
		this->dragging = false;
	}
	...
	private: System::Void UpdateStockForm_Load(System::Object^ sender, System::EventArgs^ e) {
		this->dragging = false;
	}
